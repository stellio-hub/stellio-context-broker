...
class DBConversionUtilsTests {
    ...
    fun `toJson should work for a simple string`() = runTest {
        val string = "test"
        val jsonString = string.asJsonObject()
