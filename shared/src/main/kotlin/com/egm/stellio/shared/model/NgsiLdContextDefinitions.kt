...
val toPreviousMapping = mapOf(
    NGSILD_PROPERTY_TERM to NGSILD_PROPERTY_PREVIOUS_VALUE_TERM,
    NGSILD_GEOPROPERTY_TERM to NGSILD_GEOPROPERTY_PREVIOUS_VALUE_TERM,
    NGSILD_RELATIONSHIP_TERM to NGSILD_RELATIONSHIP_PREVIOUS_OBJECT_TERM,
    NGSILD_JSONPROPERTY_TERM to NGSILD_JSONPROPERTY_PREVIOUS_JSON_TERM,
    NGSILD_LANGUAGEPROPERTY_TERM to NGSILD_LANGUAGEPROPERTY_PREVIOUS_LANGUAGEMAP_TERM,
    NGSILD_VOCABPROPERTY_TERM to NGSILD_VOCABPROPERTY_PREVIOUS_VOCAB_TERM
)
