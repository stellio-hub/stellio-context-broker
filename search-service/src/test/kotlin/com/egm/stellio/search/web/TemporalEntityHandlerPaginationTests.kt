...
class TemporalEntityHandlerPaginationTests : TemporalEntityHandlerTestCommon() {
    ...
    val range = ZonedDateTime.parse(timeAt) to ZonedDateTime.parse(endTimeAt)
    ...
    @Test
    fun `query temporal entity should return 200 if pagination was not triggered`() =
        runTest {
            setupTemporalTestWithNonTruncatedValue()
    ...
    @Test
    fun `query temporal entity should return 206 if pagination was triggered`() =
        runTest {
            setupTemporalPaginationTest()
    ...
    @Test
    fun `query temporal entity with lastN should return well formed Content-Range header`() =
        runTest {
