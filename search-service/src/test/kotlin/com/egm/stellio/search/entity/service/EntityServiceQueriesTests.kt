...
class EntityServiceQueriesTests : WithTimescaleContainer, WithKafkaContainer() {
    ...
    @CsvSource(
        ...
        "multiValuedRelationship==urn:ngsi-ld:AnotherEntity:01, 1, urn:ngsi-ld:BeeHive:01",
        "multiValuedRelationship==urn:ngsi-ld:AnotherEntity:05, 0, ",
        ...
        "multiInstanceProperty#{urn:ngsi-ld:Dataset:01}==42, 1, urn:ngsi-ld:BeeHive:01",
        "multiInstanceProperty#{urn:ngsi-ld:Dataset:01}==92, 1, urn:ngsi-ld:BeeHive:02",
        "multiInstanceProperty#{urn:ngsi-ld:Dataset:02}==44, 1, urn:ngsi-ld:BeeHive:01",
        "multiInstanceProperty#{urn:ngsi-ld:Dataset:02}==42, 0, ",
        "multiInstanceProperty#{urn:ngsi-ld:Dataset:02}.modifiedAt, 1, urn:ngsi-ld:BeeHive:01",
        "!multiInstanceProperty#{urn:ngsi-ld:Dataset:02};multiInstanceProperty, 1, urn:ngsi-ld:BeeHive:02",
    ...
    @CsvSource(
        ...
        "multiValuedRelationship,'urn:ngsi-ld:BeeHive:01,urn:ngsi-ld:BeeHive:02'",
