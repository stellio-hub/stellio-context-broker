...
fun parseAndCheckQueryParams(
    ...
    val temporalQuery = buildTemporalQuery(requestParams, withAggregatedValues)
...
fun buildTemporalQuery(params: MultiValueMap<String, String>, withAggregatedValues: Boolean = false): TemporalQuery {
