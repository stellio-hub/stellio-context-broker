...
class EntityService(
    ...
    suspend fun createEntityPayload(
        ...
        databaseClient.sql(
            """
            INSERT INTO entity_payload (entity_id, types, scopes, created_at, modified_at, payload, specific_access_policy)
            VALUES (:entity_id, :types, :scopes, :created_at, :created_at ,:payload, :specific_access_policy)
