...
const val NGSILD_LISTPROPERTY_TERM = "ListProperty"
const val NGSILD_LISTPROPERTY_VALUE_LIST_TERM = "valueList"
const val NGSILD_LISTPROPERTY_VALUE_LIST = "${NGSILD_PREFIX}hasValueList"
const val NGSILD_LISTRELATIONSHIP_TERM = "ListRelationship"
const val NGSILD_LISTRELATIONSHIP_OBJECT_LIST_TERM = "objectList"
const val NGSILD_LISTRELATIONSHIP_OBJECT_LIST = "${NGSILD_PREFIX}hasObjectList"
...
const val NGSILD_LISTPROPERTY_PREVIOUS_VALUE_LIST_TERM = "previousValueList"
const val NGSILD_LISTRELATIONSHIP_PREVIOUS_OBJECT_LIST_TERM = "previousObjectList"
...
enum class AttributesValuesMapping(
    ...
    LISTPROPERTY(
        NGSILD_LISTPROPERTY_TERM,
        NGSILD_LISTPROPERTY_PREVIOUS_VALUE_LIST_TERM,
        NGSILD_LISTPROPERTY_VALUE_LIST_TERM
    ),
    LISTRELATIONSHIP(
        NGSILD_LISTRELATIONSHIP_TERM,
        NGSILD_LISTRELATIONSHIP_PREVIOUS_OBJECT_LIST_TERM,
...
const val NGSILD_ENTITY_LIST_TERM = "entityList"
...
const val NGSILD_EXPIRES_AT_TERM = "expiresAt"
const val NGSILD_EXPIRES_AT_IRI = "${NGSILD_PREFIX}$NGSILD_EXPIRES_AT_TERM"
...
val TEMPORAL_REPRESENTATION_TERMS = listOf(
    ...
    NGSILD_VOCABS_TERM,
    NGSILD_VALUE_LISTS_TERM,
    NGSILD_OBJECTS_LISTS_TERM
)
