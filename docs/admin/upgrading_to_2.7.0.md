...
Starting from version 2.7.0, Stellio supports NGSI-LD Tenants. Please read the [multitenancy page](multitenancy.md) for an explanation of the design and the way to configure and use them.
