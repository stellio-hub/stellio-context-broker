...
val NGSILD_SYSATTRS_TERMS = setOf(
    NGSILD_CREATED_AT_TERM,
    NGSILD_MODIFIED_AT_TERM,
    NGSILD_DELETED_AT_TERM,
    NGSILD_EXPIRES_AT_TERM
)
...
val LISTPROPERTIES_CORE_MEMBERS = setOf(
    NGSILD_LISTPROPERTY_VALUE_LIST,
    NGSILD_UNIT_CODE_IRI
).plus(ATTRIBUTES_CORE_MEMBERS)

val LISTPROPERTIES_FORBIDDEN_MEMBERS = setOf(
    NGSILD_PROPERTY_VALUE,
    NGSILD_RELATIONSHIP_OBJECT,
    NGSILD_JSONPROPERTY_JSON,
    NGSILD_LISTRELATIONSHIP_OBJECT_LIST
...
val LISTRELATIONSHIPS_CORE_MEMBERS = setOf(
    NGSILD_LISTRELATIONSHIP_OBJECT_LIST
).plus(ATTRIBUTES_CORE_MEMBERS)

val LISTRELATIONSHIPS_FORBIDDEN_MEMBERS = setOf(
    NGSILD_PROPERTY_VALUE,
    NGSILD_RELATIONSHIP_OBJECT,
    NGSILD_JSONPROPERTY_JSON,
    NGSILD_LISTPROPERTY_VALUE_LIST,
