...
const val NGSILD_PROPERTY_PREVIOUS_VALUE = "${NGSILD_PREFIX}hasPreviousValue"
const val NGSILD_GEOPROPERTY_PREVIOUS_VALUE = "${NGSILD_PREFIX}hasPreviousValue"
const val NGSILD_RELATIONSHIP_PREVIOUS_OBJECT = "${NGSILD_PREFIX}hasPreviousObject"
const val NGSILD_JSONPROPERTY_PREVIOUS_JSON = "${NGSILD_PREFIX}hasPreviousJson"
const val NGSILD_LANGUAGEPROPERTY_PREVIOUS_LANGUAGEMAP = "${NGSILD_PREFIX}hasPreviousLanguageMap"
const val NGSILD_VOCABPROPERTY_PREVIOUS_VOCAB = "${NGSILD_PREFIX}hasPreviousVocab"

val toPreviousMapping = mapOf(
    NGSILD_PROPERTY_VALUE to NGSILD_PROPERTY_PREVIOUS_VALUE,
    NGSILD_GEOPROPERTY_VALUE to NGSILD_GEOPROPERTY_PREVIOUS_VALUE,
    NGSILD_RELATIONSHIP_OBJECT to NGSILD_RELATIONSHIP_PREVIOUS_OBJECT,
    NGSILD_JSONPROPERTY_JSON to NGSILD_JSONPROPERTY_PREVIOUS_JSON,
    NGSILD_LANGUAGEPROPERTY_LANGUAGEMAP to NGSILD_LANGUAGEPROPERTY_PREVIOUS_LANGUAGEMAP,
    NGSILD_VOCABPROPERTY_VOCAB to NGSILD_VOCABPROPERTY_PREVIOUS_VOCAB
)
